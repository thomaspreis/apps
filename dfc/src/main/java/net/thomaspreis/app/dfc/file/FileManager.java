...
public class FileManager extends ManagerBase {
	...
	public void copyFile(String source, String target, String fileExtension) {
		String sourceName = sourceFolder + File.separatorChar + source + fileExtension;
		sourceName = sourceName.replaceAll(String.valueOf(File.separatorChar) + String.valueOf(File.separatorChar),
				String.valueOf(File.separatorChar));
		String targetName = targetFolder + File.separatorChar + target + fileExtension;
		targetName = targetName.replaceAll(String.valueOf(File.separatorChar) + String.valueOf(File.separatorChar),
				String.valueOf(File.separatorChar));
